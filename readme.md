...
![Fig_S2a_original](Fig_S2a_original.png)

#### Fig.2A - Phreeqc results: ####
...
![Fig_S2a_inset](Fig_S2a_inset.png) ![Fig_S2a.png](Fig_S2a.png)
...
![Fig_S2b_original](Fig_S2b_original.png)

#### Fig.2B - Phreeqc results: ####
The simulated results (biomasses) agree quite well with the original model.

![Fig_S2b_inset](Fig_S2b_inset.png) ![Fig_S2b.png](Fig_S2b.png)
...
![Fig_S3a_original](Fig_S3a_original.png)

#### Fig.3A - Phreeqc results: ####
...
![Fig_S3a_inset](Fig_S3a_inset.png) ![Fig_S3a.png](Fig_S3a.png)
...
![Fig_S3b_original](Fig_S3b_original.png)

#### Fig.3B - Phreeqc results: ####
...
![Fig_S3b_inset](Fig_S3b_inset.png) ![Fig_S3b.png](Fig_S3b.png)
